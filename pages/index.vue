<template>
  <div class="index">
    ...
    <section class="index__selected">
      <movieSelected>
        <movieCard v-for="(movie, index) in selectedMovies" :key="index" :src="movie.poster_path" :title="movie.title"
          isSelected @click="deleteMovie(movie.id)" />
      </movieSelected>
    </section>
  </div>
</template>
